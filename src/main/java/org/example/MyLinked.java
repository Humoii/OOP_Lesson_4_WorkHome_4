...
public class MyLinked<E> implements Linked<E>, Iterable<E>, DescendingIterator<E>{
    ...
    public E getElementByIndex(int counter) {
        ...
        for (int i = 0; i < counter; i++){
            target = getNextElementTwo(target);
        }
        return target.getCurrentElement();
    }

    private Node<E> getNextElementTwo(Node<E> current){
